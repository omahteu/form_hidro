$(document).ready(function () {
    const video = document.getElementById('video-hidrometro-retirado');
    const canvas = document.getElementById('canvas-hidrometro-retirado');
    const captureButton = document.getElementById('capture-hidrometro-retirado');
    ...
    $('#ativar-hidrometro-retirado').on('click', function () {
